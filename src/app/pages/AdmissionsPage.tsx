  ...
  return (
    <div className="pt-20">
      <section className="py-20 bg-[var(--brand-sand)] dark:bg-[linear-gradient(160deg,#0b0f17,#121826)] relative overflow-hidden">
        ...
        <div className="absolute -top-16 right-10 h-40 w-40 rounded-full bg-[rgba(35,182,168,0.25)] blur-3xl parallax-slow dark:bg-[rgba(35,182,168,0.3)]" />
        <div className="absolute bottom-0 left-10 h-32 w-32 rounded-full bg-[rgba(246,176,66,0.25)] blur-3xl parallax-medium dark:bg-[rgba(154,210,255,0.22)]" />
      ...
      <section className="py-20 bg-white dark:bg-[linear-gradient(160deg,#0f1522,#141b29)] relative overflow-hidden">
        <div className="absolute -top-10 left-12 h-28 w-28 rounded-full bg-[rgba(154,210,255,0.2)] blur-3xl parallax-fast dark:bg-[rgba(35,182,168,0.22)]" />
      ...
      <section className="py-20 bg-[var(--brand-sand)] dark:bg-[linear-gradient(160deg,#0f1522,#131b2b)] relative overflow-hidden">
        <div className="absolute right-0 top-20 h-40 w-40 rounded-full bg-[rgba(239,107,93,0.2)] blur-3xl parallax-medium dark:bg-[rgba(154,210,255,0.2)]" />
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 relative z-10">
          <Reveal
            delay={0}
            className="bg-white border border-black/10 rounded-2xl p-8 shadow-[0_20px_50px_rgba(11,16,32,0.12)] hover:shadow-[0_30px_70px_rgba(11,16,32,0.2)] transition transform-gpu hover:-translate-y-1 dark:bg-[#141b29] dark:border-white/10 dark:shadow-[0_24px_60px_rgba(0,0,0,0.45)] dark:hover:shadow-[0_32px_70px_rgba(35,182,168,0.25)]"
          >
      ...
      <section className="py-20 bg-white dark:bg-[linear-gradient(160deg,#0f1522,#141b29)] relative overflow-hidden">
        <div className="absolute -bottom-12 left-10 h-32 w-32 rounded-full bg-[rgba(35,182,168,0.18)] blur-3xl parallax-medium dark:bg-[rgba(35,182,168,0.25)]" />
              ...
              <div className="grid gap-4">
                {programs.map((program, index) => (
                  <Reveal
                    key={program.slug}
                    delay={200 + index * 90}
                    className="bg-[var(--brand-sand)] border border-black/10 rounded-xl p-4 shadow-[0_14px_30px_rgba(11,16,32,0.12)] hover:shadow-[0_26px_55px_rgba(11,16,32,0.18)] transition dark:bg-[rgba(20,27,41,0.85)] dark:border-white/10 dark:shadow-[0_20px_45px_rgba(0,0,0,0.4)] dark:hover:shadow-[0_28px_60px_rgba(35,182,168,0.25)]"
                  >
      ...
      <section id="apply" className="py-20 bg-[var(--brand-ink)] dark:bg-[linear-gradient(160deg,#0b0f17,#121826)] text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(154,210,255,0.25),_transparent_60%)] dark:bg-[radial-gradient(circle_at_top,_rgba(35,182,168,0.35),_transparent_60%)]" />
        <div className="absolute inset-0 texture-grid opacity-25" />
        <div className="absolute -bottom-16 right-10 h-36 w-36 rounded-full bg-[rgba(246,176,66,0.25)] blur-3xl parallax-slow dark:bg-[rgba(154,210,255,0.25)]" />
