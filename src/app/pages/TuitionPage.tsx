  ...
  return (
    <div className="pt-20">
      <section className="relative bg-[var(--brand-sand)] dark:bg-[linear-gradient(160deg,#0b0f17,#121826)] py-20 overflow-hidden">
        ...
        <div className="-top-16 right-10 absolute bg-[rgba(35,182,168,0.25)] dark:bg-[rgba(35,182,168,0.3)] blur-3xl rounded-full w-36 h-36 parallax-slow" />
        <div className="z-10 relative mx-auto px-6 max-w-6xl text-center">
          ...
          {/* <Reveal delay={220}>
            <div className="inline-flex items-center bg-white/70 dark:bg-white/10 shadow-[0_12px_30px_rgba(11,16,32,0.08)] backdrop-blur mt-6 px-4 py-2 border border-black/10 dark:border-white/10 rounded-full font-medium text-slate-700 dark:text-slate-200 text-sm">
              {hasLivePricing
      ...
      <section className="relative bg-white dark:bg-[linear-gradient(160deg,#0f1522,#141b29)] py-20 overflow-hidden">
        <div className="-bottom-10 left-10 absolute bg-[rgba(246,176,66,0.2)] dark:bg-[rgba(154,210,255,0.2)] blur-3xl rounded-full w-32 h-32 parallax-medium" />
        <div className="absolute inset-0 opacity-20 texture-dots" />
        <div className="z-10 relative mx-auto px-6 max-w-6xl">
          {hasLivePricing ? (
            <Reveal
              delay={0}
              className="shadow-[0_30px_70px_rgba(11,16,32,0.15)] dark:shadow-[0_32px_70px_rgba(0,0,0,0.45)] border border-black/10 dark:border-white/10 rounded-2xl overflow-x-auto"
            >
              <table className="min-w-full text-sm text-left">
                <thead className="bg-[var(--brand-ink)] dark:bg-[linear-gradient(135deg,#1f2a44,#2ad7c7)] text-white">
                  <tr>
            ...
            <Reveal
              delay={0}
              className="bg-[var(--brand-sand)] dark:bg-[rgba(20,27,41,0.88)] shadow-[0_30px_70px_rgba(11,16,32,0.12)] dark:shadow-[0_32px_70px_rgba(0,0,0,0.45)] p-10 border border-black/10 dark:border-white/10 rounded-[28px]"
            >
              <div className="max-w-3xl">
                ...
                <div className="flex sm:flex-row flex-col gap-3 mt-6">
                  <Link
                    href="/contact"
                    className="inline-flex justify-center items-center bg-[var(--brand-ink)] hover:bg-black dark:bg-[linear-gradient(135deg,#1f2a44,#2ad7c7)] dark:hover:bg-[linear-gradient(135deg,#243152,#35e2cf)] shadow-[0_18px_50px_rgba(11,16,32,0.24)] px-6 py-3 rounded-full font-semibold text-white text-sm transition"
                  >
                    Contact Admissions
                  </Link>
                  <Link
      ...
      <section className="relative bg-[var(--brand-sand)] dark:bg-[linear-gradient(160deg,#0f1522,#131b2b)] py-20 overflow-hidden">
        <div className="top-10 right-10 absolute bg-[rgba(154,210,255,0.25)] dark:bg-[rgba(35,182,168,0.22)] blur-3xl rounded-full w-32 h-32 parallax-medium" />
        <div className="absolute inset-0 opacity-20 texture-dots" />
        <div className="z-10 relative gap-10 grid md:grid-cols-2 mx-auto px-6 max-w-6xl">
          <Reveal
            delay={0}
            className="bg-white dark:bg-[#141b29] shadow-[0_22px_50px_rgba(11,16,32,0.12)] hover:shadow-[0_32px_70px_rgba(11,16,32,0.2)] dark:hover:shadow-[0_32px_70px_rgba(35,182,168,0.25)] dark:shadow-[0_26px_60px_rgba(0,0,0,0.45)] p-8 border border-black/10 dark:border-white/10 rounded-2xl transform-gpu transition hover:-translate-y-1"
          >
