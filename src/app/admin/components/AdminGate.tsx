...
export function AdminGate({
  ...
  if (status === 'checking') {
    return (
      <div className="flex min-h-[320px] flex-col items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm dark:bg-[#141b29] dark:border-white/10 dark:shadow-[0_20px_45px_rgba(0,0,0,0.45)]">
  ...
  if (status !== 'authenticated') {
    return (
      <div className="flex min-h-[320px] flex-col items-center justify-center gap-4 rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm dark:bg-[#141b29] dark:border-white/10 dark:shadow-[0_20px_45px_rgba(0,0,0,0.45)]">
        ...
        <Link
          href="/admin/login"
          className="admin-glow rounded-full bg-slate-900 px-5 py-2 text-xs font-semibold uppercase tracking-wide text-white dark:bg-[linear-gradient(135deg,#1f2a44,#2ad7c7)]"
        >
          Go to login
        </Link>
      </div>
