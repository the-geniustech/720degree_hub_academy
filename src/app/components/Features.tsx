...
export function Features() {
  return (
    <section
      id="features"
      className="relative bg-[var(--brand-sand)] dark:bg-[linear-gradient(160deg,#00152a,#001b36)] py-20 overflow-hidden"
    >
      <div className="-top-24 right-0 absolute bg-[rgba(219,231,243,0.35)] dark:bg-[rgba(240,128,16,0.22)] blur-3xl rounded-full w-40 h-40 parallax-fast" />
      <div className="bottom-0 left-10 absolute bg-[rgba(217,103,4,0.2)] dark:bg-[rgba(219,231,243,0.18)] blur-3xl rounded-full w-32 h-32 parallax-slow" />
          ...
          {features.map((feature, index) => {
            ...
            return (
              <Reveal
                ...
                delay={index * 110}
                speed="fast"
                className="bg-white dark:bg-[#071a33] shadow-[0_18px_45px_rgba(0,16,32,0.08)] hover:shadow-[0_30px_60px_rgba(0,16,32,0.16)] dark:hover:shadow-[0_30px_70px_rgba(240,128,16,0.25)] dark:shadow-[0_24px_60px_rgba(0,0,0,0.4)] p-8 border border-black/10 dark:border-white/10 rounded-2xl transform-gpu transition hover:-translate-y-1 hover:[transform:perspective(800px)_rotateX(1deg)_rotateY(1deg)]"
              >
                <div className="flex justify-center items-center bg-[var(--brand-ink)] dark:bg-[linear-gradient(135deg,#002040,#f08010)] shadow-[0_12px_30px_rgba(0,16,32,0.25)] dark:shadow-[0_18px_40px_rgba(240,128,16,0.35)] mb-6 rounded-xl w-14 h-14">
