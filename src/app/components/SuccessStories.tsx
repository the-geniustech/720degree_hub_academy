...
export function SuccessStories() {
  ...
  return (
    <section className="py-20 px-6 bg-white dark:bg-[linear-gradient(160deg,#00152a,#071a33)] relative overflow-hidden">
      <div className="absolute -top-24 left-10 h-36 w-36 rounded-full bg-[rgba(240,128,16,0.15)] blur-3xl parallax-medium dark:bg-[rgba(240,128,16,0.24)]" />
      <div className="absolute bottom-0 right-10 h-40 w-40 rounded-full bg-[rgba(219,231,243,0.2)] blur-3xl parallax-fast dark:bg-[rgba(219,231,243,0.2)]" />
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {standards.map((standard, index) => (
            <Reveal
              ...
              delay={index * 120}
              speed="fast"
              className="bg-[var(--brand-sand)] rounded-2xl border border-black/10 p-8 shadow-[0_20px_45px_rgba(0,16,32,0.12)] hover:shadow-[0_30px_60px_rgba(0,16,32,0.18)] transition transform-gpu hover:-translate-y-1 hover:[transform:perspective(900px)_rotateX(1deg)_rotateY(1deg)] dark:bg-[rgba(20,27,41,0.85)] dark:border-white/10 dark:shadow-[0_24px_60px_rgba(0,0,0,0.4)] dark:hover:shadow-[0_30px_70px_rgba(240,128,16,0.25)]"
            >
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {[
            ...
            <Reveal
              ...
              delay={index * 120}
              speed="fast"
              className="bg-white border border-black/10 rounded-2xl p-6 text-sm text-slate-700 shadow-[0_16px_35px_rgba(0,16,32,0.08)] dark:bg-[#071a33] dark:border-white/10 dark:text-slate-300 dark:shadow-[0_20px_45px_rgba(0,0,0,0.4)]"
            >
              {note}
            </Reveal>
          ))}
