...
import { cohorts, locations, programs, schedule } from '../src/app/lib/programs';
...
const sampleContacts = [
  ...
  },
  {
    ...
    message: 'I want to know if the Lagos facility is available for the September cohort.',
    source: 'contact',
  },
  {
    name: 'Emeka Johnson',
...
async function main() {
  ...
  const seedToken =
    process.env.ADMIN_SEED_TOKEN || process.env.ADMIN_TOKEN || 'dev-super-admin-token';
